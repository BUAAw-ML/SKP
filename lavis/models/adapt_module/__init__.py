...
from lavis.models.adapt_module.peft_wrapper import BaseModelPeftWrapper
...
def get_amortize_encdec_model(cfg):
    print(cfg)
    if 't5' in cfg.pretrained_model_amort:
        ...
        amort_model = AmortEncDecAggregateWrapper(
            cfg, enc_decoder=t5model, question_encoder=question_encoder
        )

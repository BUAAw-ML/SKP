...
class OKVQAEvalDataset(VQAEvalDataset, __DisplMixin):
    ...
    #   for caption_file_path in module_config.config.values():
        ...
        knowledge_file = "evalRetriever" + str(retrieve_knowledge_num) + ".json"
        ...
        if not os.path.exists(knowledge_file):
            print('retrieve external knowledge for val dataset!')
            self.retriever_data(self.annotation, output_filename='evalRetriever', top_k=retrieve_knowledge_num)
        ####################

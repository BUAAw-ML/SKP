...
class Blip2Base(BaseModel):
    ...
    def init_tokenizer(cls, truncation_side="right"):
        tokenizer = BertTokenizer.from_pretrained("/public/qbwang/public/models--bert-base-uncased", cache_dir="/public/qbwang/public", truncation_side=truncation_side)
    ...
    def init_Qformer(cls, num_query_token, vision_width, cross_attention_freq=2):
        encoder_config = BertConfig.from_pretrained("/public/qbwang/public/models--bert-base-uncased")
        ...
        Qformer = BertLMHeadModel.from_pretrained(
            "/public/qbwang/public/models--bert-base-uncased", config=encoder_config
        )
